...
const MaintenancePage = () => {
  ...
  const handleArchive = async (id) => {
    try {
      // Since your store might not have a specific archive function,
      // we can use deleteMaintenance which performs the same action
      // You can add an archiveMaintenance function to your store if needed
