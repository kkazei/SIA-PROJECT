        ...
        >
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mb-8'>
                ...
                >
                    ...
                    <p className='text-gray-300 mb-2'>Role: {user.role || "Tenant"}</p>
                ...
                >
                    <h3 className='text-xl font-semibold text-green-400 mb-3'>Property Overview</h3>
                    <p className='text-gray-300'>Total Units: 42</p>
                    <p className='text-gray-300'>Available Units: 5</p>
                    <p className='text-gray-300'>Occupancy Rate: 88%</p>
                </motion.div>
            </div>
