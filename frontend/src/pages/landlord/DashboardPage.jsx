    ...
    return (
        <div className="flex flex-col lg:flex-row">
            ...
            >
                ...
                <div className='bg-gray-900 shadow-md rounded-lg p-4 lg:p-6 mt-4 lg:mt-6'>
                    <h3 className='text-lg lg:text-xl font-bold text-white'>Apartment List</h3>
                    {isLoading ? (
                        ...
                        <div className="overflow-x-auto">
                            <table className='w-full mt-4 border border-gray-300 text-sm lg:text-base'>
                                <thead>
