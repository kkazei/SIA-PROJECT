...
return (
    <div className={`fixed left-0 top-0 h-full ${isMaximized ? 'w-64' : 'w-16'} bg-gray-800 text-white p-4 transition-all`}>
        ...
        <nav>
    <ul className="space-y-4 mt-20"> {/* Increased margin-top */}
        ...
        <li>
            ...
            >
                <img src="/image/dashboard.png" alt="Dashboard" className="w-15 h-6" />
                {isMaximized && 'Dashboard'}
            </Link>
        </li>
        ...
        <li>
            <Link 
                to="/announcement" 
                className={`flex items-center pl-1 py-2 gap-3 rounded-lg ${
                    location.pathname === "/announcement" ? "bg-gray-700" : "hover:bg-black"
                }`}
            >
                <img src="/image/announcement.png" alt="Announcements" className="w-6 h-6" />
                {isMaximized && 'Announcements'}
            </Link>
        </li>
        ...
        <li>
            <Link 
                to="/tenant-page" 
                className={`flex items-center pl-1 py-2 gap-3 rounded-lg ${
                    location.pathname === "/tenant-page" ? "bg-gray-700" : "hover:bg-black"
                }`}
            >
        ...
        <li>
            <Link 
                to="/maintenance-page" 
                className={`flex items-center pl-1 py-2 gap-3 rounded-lg ${
                    location.pathname === "/maintenance-page" ? "bg-gray-700" : "hover:bg-black"
                }`}
            >
                <img src="/image/maintenance.png" alt="Maintenance" className="w-6 h-6" />
                {isMaximized && 'Maintenance'}
            </Link>
        </li>
        ...
        <li>
            <Link 
                to="/archive-page" 
                className={`flex items-center pl-1 py-2 gap-3 rounded-lg ${
                    location.pathname === "/archive-page" ? "bg-gray-700" : "hover:bg-black"
                }`}
            >
